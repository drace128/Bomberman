...
void LCD_Bomberman(int16_t xStart, int16_t xEnd, int16_t yStart, int16_t yEnd, uint16_t *table)
{
    // Optimization complexity: O(64 + 2N) Bytes Written
...
void LCD_Init(bool usingTP)
{
    ...
    LCD_WriteReg(RGB_DISPLAY_INTERFACE_CONTROL_1, 0x0001); /* RGB interface setting */
