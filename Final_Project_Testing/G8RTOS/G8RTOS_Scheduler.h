 ...
 */
int32_t G8RTOS_AddThread(void (*threadToAdd)(void), char *str, uint8_t priority);
 ...
 */
void G8RTOS_OS_Sleep(uint32_t duration);
...
void G8RTOS_AddPeriodicEvent(void (*eventToAdd)(void), uint32_t period);
